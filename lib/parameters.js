...
var unknownFormats = require('./unknown-formats')
var ajv = require('ajv')({ coerceTypes: ['number', 'boolean'], unknownFormats: unknownFormats })
...
function throwMissingRequiredParameter (param) {
  if (settings.get('validateRequiredParameters') === false) return
